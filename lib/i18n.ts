...
const en: Dict = {
  ...
  // ---- Landing ----
  "home.badge": "Explainable AI · EN / VI · trained on 58,020 balanced posts",
  ...
  "home.stat.posts": "balanced training posts",
  ...
  "an.queue.add": "Add this analysis to the queue",
  "an.queue.running": "AI analyses are running · new submissions will be queued",
  "an.queue.pending": "AI analyses are running · {0} waiting",
  "queue.analysis.title": "Analysis queued",
  "queue.analysis.message": "Position {0} · It will start automatically.",
  "queue.report.title": "Report request received",
  "queue.report.submitting": "Submitting the report · you can keep working.",
  "queue.report.message": "Pending · position {0} in the report queue.",
  "queue.report.running": "The report is now being generated.",
  ...
  "rep.submitting": "Adding the report to the queue…",
  "rep.queued": "Report queued · position {0}",
  "rep.running": "Generating the report…",
  ...
  "hist.status.all": "All statuses",
  "hist.status.completed": "Completed",
  "hist.status.running": "In progress",
  "hist.status.pending": "Pending",
  ...
  "in.subtitle": "Explore the training data, feature families and evaluation metrics behind each prediction model.",
  "in.dataset": "Dataset",
  ...
  "in.x.sub": "posts",
  "model.fusion-v1.blurb": "Fusion combines content, audience, marketing-role and EV-topic signals in one XGBoost prediction. Trained on 3,990 posts.",
  "model.audience-x90.blurb": "The same signal-fusion approach, trained on 58,020 source-balanced posts. Strongest on X; use Reddit scores with caution.",
  ...
  "in.kicker": "Model intelligence",
  "in.models.available": "models available",
  "in.snapshot": "Model portfolio snapshot",
  "in.snapshot.scale": "more training rows in the 58K dataset",
  "in.snapshot.languages": "English and Vietnamese",
  "in.snapshot.platforms": "social platforms",
  "in.snapshot.validation": "grouped validation",
  "in.modelcatalog": "Models & training data",
  "in.badge.default": "Initial dataset",
  "in.badge.audience": "Balanced dataset",
  "in.overall.roc": "Overall ROC-AUC",
  "in.labelled.posts": "labelled EV posts",
  "in.fusion.dataset": "Original training corpus. Its source mix reflects the data available at the time and is not evenly distributed.",
  "in.x90.dataset": "Expanded corpus, balanced to exactly 19,340 observations per platform before training.",
  "in.features": "Feature families",
  "in.multisignal": "Multi-signal",
  "in.feature.families": "feature architecture",
  "in.engineered.features": "engineered variables",
  "in.feature.content": "Content & structure",
  "in.feature.language": "Language complexity",
  "in.feature.roles": "Marketing roles",
  "in.feature.topics": "EV topics",
  "in.feature.context": "Platform & language",
  "in.feature.audience": "Audience reach",
  "in.audience.coverage": "Audience coverage",
  "in.fusion.audience": "Available as a signal, but coverage is uneven across the historical corpus.",
  "in.x90.audience": "YouTube 99.8% · X 90.7% · Reddit unavailable. Reddit does not currently use user karma as audience.",
  "in.validation": "Evaluation design",
  "in.fusion.validation": "Historical held-out evaluation on the original corpus.",
  "in.x90.validation": "Five-fold StratifiedGroupKFold, grouped by author to prevent the same author appearing in training and validation.",
  "in.validation.caption": "ROC-AUC measures ranking quality: 0.5 is random, 1.0 is ideal.",
  "in.reading.title": "How to read model metrics",
  "in.reading.note": "Compare scores alongside dataset size, source balance, label distribution and evaluation design. Models tested under different conditions are not a strict head-to-head benchmark: a lower score can reflect broader data or a harder, more realistic validation set.",
...
const vi: Dict = {
  ...
  // ---- Landing ----
  "home.badge": "AI giải thích được · EN / VI · huấn luyện trên 58.020 bài cân bằng",
  ...
  "home.stat.posts": "bài huấn luyện cân bằng",
  ...
  "an.queue.add": "Thêm phân tích này vào hàng đợi",
  "an.queue.running": "Phân tích AI đang chạy · yêu cầu mới sẽ được xếp hàng",
  "an.queue.pending": "Phân tích AI đang chạy · {0} yêu cầu đang chờ",
  "queue.analysis.title": "Phân tích đã vào hàng đợi",
  "queue.analysis.message": "Vị trí {0} · phân tích sẽ tự động bắt đầu.",
  "queue.report.title": "Đã nhận yêu cầu báo cáo",
  "queue.report.submitting": "Đang gửi báo cáo · bạn có thể tiếp tục làm việc.",
  "queue.report.message": "Đang chờ · vị trí {0} trong hàng đợi báo cáo.",
  "queue.report.running": "Báo cáo đang được tạo.",
  ...
  "rep.submitting": "Đang thêm báo cáo vào hàng đợi…",
  "rep.queued": "Báo cáo đang chờ · vị trí {0}",
  "rep.running": "Đang tạo báo cáo…",
  ...
  "hist.status.all": "Tất cả trạng thái",
  "hist.status.completed": "Hoàn tất",
  "hist.status.running": "Đang chạy",
  "hist.status.pending": "Đang chờ",
  ...
  "in.subtitle": "Khám phá dữ liệu huấn luyện, nhóm đặc trưng và chỉ số đánh giá của từng mô hình dự đoán.",
  ...
  "in.x.sub": "bài",
  "model.fusion-v1.blurb": "Fusion kết hợp nội dung, người theo dõi, vai trò marketing và chủ đề xe điện trong một dự đoán XGBoost. Huấn luyện trên 3.990 bài.",
  "model.audience-x90.blurb": "Cùng phương pháp kết hợp tín hiệu Fusion, được huấn luyện trên 58.020 bài cân bằng theo nguồn. Mạnh nhất trên X; cần thận trọng với điểm Reddit.",
  ...
  "in.kicker": "Thông tin mô hình",
  "in.models.available": "mô hình khả dụng",
  "in.snapshot": "Tổng quan danh mục mô hình",
  "in.snapshot.scale": "nhiều dữ liệu huấn luyện hơn trong tập 58K",
  "in.snapshot.languages": "Tiếng Anh và tiếng Việt",
  "in.snapshot.platforms": "nền tảng mạng xã hội",
  "in.snapshot.validation": "kiểm định theo nhóm",
  "in.modelcatalog": "Mô hình & dữ liệu huấn luyện",
  "in.badge.default": "Tập dữ liệu ban đầu",
  "in.badge.audience": "Tập dữ liệu cân bằng",
  "in.overall.roc": "ROC-AUC tổng thể",
  "in.labelled.posts": "bài viết xe điện đã gán nhãn",
  "in.fusion.dataset": "Tập huấn luyện ban đầu. Phân bổ theo nguồn phản ánh dữ liệu có sẵn lúc đó và chưa cân bằng.",
  "in.x90.dataset": "Tập dữ liệu mở rộng, được cân bằng chính xác 19.340 quan sát cho mỗi nền tảng trước khi huấn luyện.",
  "in.features": "Nhóm đặc trưng",
  "in.multisignal": "Đa tín hiệu",
  "in.feature.families": "kiến trúc đặc trưng",
  "in.engineered.features": "biến được thiết kế",
  "in.feature.content": "Nội dung & cấu trúc",
  "in.feature.language": "Độ phức tạp ngôn ngữ",
  "in.feature.roles": "Vai trò marketing",
  "in.feature.topics": "Chủ đề xe điện",
  "in.feature.context": "Nền tảng & ngôn ngữ",
  "in.feature.audience": "Quy mô khán giả",
  "in.audience.coverage": "Độ phủ dữ liệu khán giả",
  "in.fusion.audience": "Được sử dụng như một tín hiệu, nhưng độ phủ không đồng đều trong tập dữ liệu lịch sử.",
  "in.x90.audience": "YouTube 99,8% · X 90,7% · Reddit chưa có. Reddit hiện chưa sử dụng karma người dùng làm dữ liệu khán giả.",
  "in.validation": "Thiết kế đánh giá",
  "in.fusion.validation": "Đánh giá hold-out lịch sử trên tập dữ liệu ban đầu.",
  "in.x90.validation": "StratifiedGroupKFold năm phần, nhóm theo tác giả để cùng một tác giả không xuất hiện trong cả huấn luyện và kiểm định.",
  "in.validation.caption": "ROC-AUC đo khả năng xếp hạng: 0,5 là ngẫu nhiên, 1,0 là lý tưởng.",
  "in.reading.title": "Cách đọc chỉ số mô hình",
  "in.reading.note": "Hãy so sánh điểm số cùng với quy mô dữ liệu, mức cân bằng nguồn, phân phối nhãn và thiết kế đánh giá. Các mô hình được kiểm tra trong điều kiện khác nhau không phải phép đối chiếu trực tiếp tuyệt đối: điểm thấp hơn có thể phản ánh dữ liệu rộng hơn hoặc tập kiểm định khó và thực tế hơn.",
...
const FACTOR_KEYS: Record<string, string> = {
  ...
  role_ratio_proof: "fac.r_proof", role_n_proof: "fac.r_proof",
  role_ratio_benefit: "fac.r_benefit", role_n_benefit: "fac.r_benefit",
  role_ratio_cta: "fac.r_cta", role_n_cta: "fac.r_cta",
  role_ratio_social_proof: "fac.r_social", role_n_social_proof: "fac.r_social",
  role_ratio_objection_handling: "fac.r_objection", role_n_objection_handling: "fac.r_objection",
  role_ratio_pain_point: "fac.r_pain", role_n_pain_point: "fac.r_pain",
  role_ratio_scarcity: "fac.r_scarcity", role_n_scarcity: "fac.r_scarcity",
  role_ratio_solution: "fac.r_solution", role_n_solution: "fac.r_solution",
  role_ratio_storytelling: "fac.r_story", role_n_storytelling: "fac.r_story",
  role_ratio_educational: "fac.r_edu", role_n_educational: "fac.r_edu",
  role_n_hook: "fac.hook", role_n_urgency: "fac.urgency",
  role_diversity: "fac.r_diversity", role_n_segments: "fac.n_segments",
  has_question: "fac.question", word_count: "fac.words",
  f_sent: "fac.sent", f_clause: "fac.clause", f_visual: "fac.visual",
  engagement_score: "fac.engagement", is_vietnamese: "fac.vietnamese",
};
const FAC_EN: Dict = {
  ...
  "fac.r_proof": "Proof & evidence",
  "fac.r_benefit": "Benefits highlighted",
  "fac.r_cta": "Call-to-action",
  "fac.r_social": "Social proof",
  "fac.r_objection": "Objection handling",
  "fac.r_pain": "Pain points",
  "fac.r_scarcity": "Scarcity / urgency",
  "fac.r_solution": "Solution framing",
  "fac.r_story": "Storytelling",
  "fac.r_edu": "Educational tone",
  "fac.r_diversity": "Message variety",
  "fac.n_segments": "Number of segments",
  "fac.question": "Uses a question",
  "fac.words": "Post length (words)",
  "fac.sent": "Sentence complexity",
  "fac.clause": "Clause density",
  "fac.visual": "Visual cues",
  "fac.engagement": "Engagement signal",
  "fac.vietnamese": "Vietnamese text",
};
const FAC_VI: Dict = {
  ...
  "fac.r_proof": "Bằng chứng & dẫn chứng",
  "fac.r_benefit": "Lợi ích nêu bật",
  "fac.r_cta": "Lời kêu gọi hành động",
  "fac.r_social": "Bằng chứng xã hội",
  "fac.r_objection": "Xử lý phản đối",
  "fac.r_pain": "Điểm đau (pain point)",
  "fac.r_scarcity": "Khan hiếm / khẩn cấp",
  "fac.r_solution": "Định hướng giải pháp",
  "fac.r_story": "Kể chuyện",
  "fac.r_edu": "Giọng giáo dục",
  "fac.r_diversity": "Đa dạng thông điệp",
  "fac.n_segments": "Số phân đoạn",
  "fac.question": "Có câu hỏi",
  "fac.words": "Độ dài bài (từ)",
  "fac.sent": "Độ phức tạp câu",
  "fac.clause": "Mật độ mệnh đề",
  "fac.visual": "Yếu tố hình ảnh",
  "fac.engagement": "Tín hiệu tương tác",
  "fac.vietnamese": "Văn bản tiếng Việt",
};
