...
const en: Dict = {
  ...
  "model.audience-x90.blurb": "Audience-enriched model evaluated on 58,020 balanced posts. Strongest on X; use Reddit scores with caution.",
  ...
  "in.snapshot.scale": "more training rows in Audience X90",
  ...
  "in.badge.default": "Default · legacy",
  "in.badge.audience": "Audience enriched",
...
const vi: Dict = {
  ...
  "model.audience-x90.blurb": "Mô hình bổ sung dữ liệu người theo dõi, đánh giá trên 58.020 bài cân bằng. Mạnh nhất trên X; cần thận trọng với điểm Reddit.",
  ...
  "in.snapshot.scale": "nhiều dữ liệu huấn luyện hơn trong Audience X90",
  ...
  "in.badge.default": "Mặc định · cũ",
  "in.badge.audience": "Bổ sung dữ liệu khán giả",
