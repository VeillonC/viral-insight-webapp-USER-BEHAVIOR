...
const en: Dict = {
  ...
  // ---- Landing ----
  "home.badge": "Explainable AI · EN / VI · trained on 600k+ posts",
  ...
  "in.dataset": "Dataset",
  "in.corpus": "Total corpus",
  "in.corpus.sub": "cleaned social-media events",
  "in.yt.sub": "videos + comments",
  "in.rd.sub": "posts + comments",
  "in.x.sub": "posts (still growing)",
...
const vi: Dict = {
  ...
  // ---- Landing ----
  "home.badge": "AI giải thích được · EN / VI · huấn luyện trên hơn 600k bài",
  ...
  "in.corpus": "Tổng kho ngữ liệu",
  "in.corpus.sub": "sự kiện mạng xã hội đã làm sạch",
  "in.yt.sub": "video + bình luận",
  "in.rd.sub": "bài + bình luận",
  "in.x.sub": "bài (vẫn đang tăng)",
